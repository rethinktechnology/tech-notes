...
|https://en.wikipedia.org/wiki/Declarative_programming[Declarative Programming]|https://en.wikipedia.org/wiki/Imperative_programming[Imperative Programming]
...
|https://jenkins.io/doc/book/pipeline/[Jenkins Pipeline]|http://groovy-lang.org/[Groovy]
